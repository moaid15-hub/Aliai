  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/chat/send`, {
        ...
        body: JSON.stringify({ 
          content: inputValue,
          conversation_id: null // سينشئ محادثة جديدة إذا لم تكن موجودة
        }),
      });
      ...
      const aiMessage: Message = {
        ...
        role: 'assistant',
        content: data.message?.content || data.response || 'عذراً، حدث خطأ في الاتصال',
        timestamp: new Date()
      };
      ...
      const errorMessage: Message = {
        ...
        role: 'assistant',
        content: 'عذراً، لا يمكن الاتصال بالخادم حالياً. يرجى المحاولة لاحقاً.',
        timestamp: new Date()
      };
