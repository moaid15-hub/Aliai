...
import './chat.css';
import { sendToAIIntelligent } from './ai-service';
...
import { needsSearch, getSearchMode } from './search';
...
import { SearchCardProps } from './search/SearchCard';
...
✨ ${data.sources.length} نتيجة من مصادر متعددة: YouTube, Google, Wikipedia & StackOverflow`,
  ...
  const navigateToPersonas = () => {
    ...
    showToast('انتقال لصفحة الشخصيات', 'info');
  };
    ...
    <>
      ...
      <div className="sidebar">
        ...
        >
          <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="60" cy="60" r="12" fill="#5eb4eb"/>
            <line x1="60" y1="60" x2="60" y2="20" stroke="#5eb4eb" strokeWidth="3" strokeLinecap="round"/>
            <line x1="60" y1="60" x2="85" y2="32" stroke="#5eb4eb" strokeWidth="3" strokeLinecap="round"/>
            <line x1="60" y1="60" x2="95" y2="50" stroke="#5eb4eb" strokeWidth="3" strokeLinecap="round"/>
            <line x1="60" y1="60" x2="95" y2="70" stroke="#5eb4eb" strokeWidth="3" strokeLinecap="round"/>
            <line x1="60" y1="60" x2="85" y2="88" stroke="#5eb4eb" strokeWidth="3" strokeLinecap="round"/>
            <line x1="60" y1="60" x2="60" y2="100" stroke="#5eb4eb" strokeWidth="3" strokeLinecap="round"/>
            <line x1="60" y1="60" x2="35" y2="88" stroke="#5eb4eb" strokeWidth="3" strokeLinecap="round"/>
            <line x1="60" y1="60" x2="25" y2="70" stroke="#5eb4eb" strokeWidth="3" strokeLinecap="round"/>
            <line x1="60" y1="60" x2="25" y2="50" stroke="#5eb4eb" strokeWidth="3" strokeLinecap="round"/>
            <line x1="60" y1="60" x2="35" y2="32" stroke="#5eb4eb" strokeWidth="3" strokeLinecap="round"/>
            {[
              [60, 20], [85, 32], [95, 50], [95, 70], [85, 88],
              [60, 100], [35, 88], [25, 70], [25, 50], [35, 32]
            ].map(([cx, cy], i) => (
              <circle key={i} cx={cx} cy={cy} r="4" fill="#5eb4eb"/>
            ))}
          </svg>
        </div>
        ...
        {[
          { title: 'الشخصيات', path: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', action: navigateToPersonas },
      ...
      <div className={`main-content ${isChatMode ? 'chat-mode' : ''}`}>
        <div className={`logo-container ${isChatMode ? 'hidden' : ''}`}>
          <div className="logo-text">OqoolAI</div>
        </div>
        ...
        {isChatMode && (
          <div style={{
            ...
            <h1 style={{
              fontSize: '28px',
              fontWeight: '700',
              background: 'linear-gradient(135deg, #5eb4eb, #3b9edd)',
        ...
        <div className={`chat-messages ${isChatMode ? 'active' : ''}`}>
          ...
          {messages.map((msg, msgIndex) => (
            <div key={msg.id} className={`message ${msg.type}`}>
              <div className="message-avatar">{msg.type === 'user' ? 'أنت' : 'AI'}</div>
              <div style={{ width: '100%' }}>
                  ...
                  <div style={{ marginTop: '16px' }}>
                    ...
                    <div style={{
                      ...
                      <button
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.borderColor = '#5eb4eb';
                          e.currentTarget.style.color = '#5eb4eb';
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.borderColor = '#3a3c3c';
                        ...
                        {['اشرح أكثر عن هذا الموضوع', 'ما هي التطبيقات العملية؟', 'هل هناك أمثلة إضافية؟'].map((question, idx) => (
                          <button
                            ...
                            onMouseEnter={(e) => {
                              e.currentTarget.style.borderColor = '#5eb4eb';
                              e.currentTarget.style.color = '#5eb4eb';
                              e.currentTarget.style.background = 'rgba(94, 180, 235, 0.1)';
                            }}
                            onMouseLeave={(e) => {
                              e.currentTarget.style.borderColor = '#3a3c3c';
                              e.currentTarget.style.color = '#b0b0b0';
                              e.currentTarget.style.background = '#2a2c2c';
                            }}
                          >
                            💡 {question}
                          </button>
        ...
        <div className={`search-container ${isChatMode ? 'chat-mode' : ''}`}>
          <div className="search-box">
            ...
            <div 
              ...
              onClick={() => sendMessage()}
              style={{ 
                backgroundColor: inputValue.trim() ? '#5eb4eb' : '#666',
      ...
      <div className="bottom-info">
        ...
        <a 
          ...
          style={{ cursor: 'pointer', color: '#5eb4eb', fontWeight: 'bold' }}
        >🔗</a>
      </div>
    </>
  );
