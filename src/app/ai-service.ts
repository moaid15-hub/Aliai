...
// دالة للتحقق من حاجة السؤال للبحث
function needsSearch(message: string): boolean {
  const searchKeywords = [
    'ابحث', 'بحث', 'search', 'find', 'أين', 'where', 'متى', 'when',
    'كيف', 'how', 'ماذا', 'what', 'من هو', 'who is', 'آخر أخبار',
    'latest', 'حالي', 'current', 'الآن', 'now', 'اليوم', 'today'
  ];
